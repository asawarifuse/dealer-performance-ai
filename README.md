...
## Dashboard Pages
1. Executive Summary — High-level KPIs, trends, bottom 10 dealers
2. Dealer Deep Dive — Single dealer view, 11 KPI trends
3. Dealer Comparison — Regional filter, scatter plot, ranking
4. Anomaly Center — Flagged dealers, anomaly trends, pie charts
...
├── 02_Excel_Outputs/      # Scored datasets
